...
const getClassNames = name => {
  ...
  return {
    enter: `jm-${name}-enter jm-${name}-enter-active`,
    'enter-to': `jm-${name}-enter-to jm-${name}-enter-active`,
    leave: `jm-${name}-leave jm-${name}-leave-active`,
    'leave-to': `jm-${name}-leave-to jm-${name}-leave-active`
  }
}
